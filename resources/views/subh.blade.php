...
<header>
    ...
    <div class="user">
        <img src="{{('frontend/img/portfolio/Sub.jpg')}}" alt="">
...
<div class="row">
    ...
    <div class="info">
        ...
        <a href="{{('frontend/img/Portfolio/Resume.pdf')}}" target="_blank"><button class="btn"> Download Resume <i class="fas fa-download"></i> </button></a>
    </div>
