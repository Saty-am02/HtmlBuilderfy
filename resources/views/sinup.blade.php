...
<head>
  ...
  <link rel="stylesheet" href="{{asset('frontend/sinup.css')}}">
            ...
            <form action="{{route('user.add')}}" method="post">
              ...
              @csrf
                ...
                <div class="inputBox">
                    ...
                    <span class="text-danger"><h6>
                      @error('password')
                        {{'Password should contain atleast one uppercase letter, lowercase letter, number, special character and should be atleast 8 characters long'}}
                      @enderror
                      </h6>
                    </span>
                </div>
                ...
                <p class="forget">Already have an account ?<a href="{{url('/login')}}">Login</a></p>
