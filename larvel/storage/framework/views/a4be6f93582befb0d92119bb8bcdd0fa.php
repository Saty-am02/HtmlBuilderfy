...
<head>
    ...
    <!-- custom css file link  
         ...
         custom css file link  -->
         <link rel="stylesheet" href="<?php echo e(asset('frontend/portfoli/style.css')); ?>">
</head>
<body>
...
<header>
    ...
    <div class="user">
        <img src="<?php echo e(('frontend/img/portfolio/Sub.jpg')); ?>" alt="">
        <h3 class="name">Subramanya S Hegde</h3>
...
<section class="home" id="home">
    ...
    <h3>HI THERE !</h3>
    <h1>I'M <span>Subramanya S  Hegde</span></h1>
    <p>
...
<div class="row">
    ...
    <div class="info">
        <h3> <span> Name : </span> Subramanya S Hegde</h3>
        ...
        <a href="<?php echo e(('frontend/img/Portfolio/Resume.pdf')); ?>" target="_blank"><button class="btn"> Download Resume <i class="fas fa-download"></i> </button></a>
    </div>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <p>
           Studied from SVHS Goli(Karnataka Secondary Education Examination Board)
        </p>
        <p>
            Grade - 94.04% 
        </p>
    ...
    <div class="box">
        ...
        <p>
            Studied from Shree Marikamba  Goerment PU college Sirsi
        </p>
        <p>Grade - 79.33%</p>
    </div>
    ...
    <div class="box">
        ...
        <h3>BCA</h3>
        <p>
            Studied from JSS SMI UG& PG STUDIES VIDHAGIRI DHARWAD
...
<div class="box">
     ...
     <img src="<?php echo e(asset('frontend/img/portfolio/html5.webp')); ?>" alt="mobile app Development">
 </div>

 <div class="box">
     <img src="<?php echo e(asset('frontend/img/portfolio/Java-Logo.png')); ?>" alt="">
     
 </div>

 <div class="box">
     <img src="<?php echo e(asset('frontend/img/portfolio/React.png')); ?>" alt="">
 </div>

 <div class="box">
     <img src="<?php echo e(asset('frontend/img/portfolio/android-logo.png')); ?>" alt="">
 </div>

 <div class="box">
     <img src="<?php echo e(asset('frontend/img/portfolio/c-logo.png')); ?>" alt="">
 </div>

 <div class="box">
     <img src="<?php echo e(asset('frontend/img/portfolio/Angular_js.png')); ?>" alt="">
 </div>
...
<div class="row">
    ...
    <div class="content">
        ...
        <div class="info">
            <h3> <i class="fas fa-envelope"></i>subrahmanyahegde460@gmail.com</h3>
            <h3> <i class="fas fa-phone"></i> +91-8296391957</h3>
            <h3> <i class="fa-brands fa-linkedin-in"></i> 
                <a href="https://www.linkedin.com/in/subrahmanya-s-hegde-071435267/" target="_blank">Linkedin</a>
               

                <a href="https://profile.indeed.com/?hl=en_IN&co=IN&from=gnav-jobseeker-profile--profile-one-frontend" target="_blank"></a>
               

                
                    <h3><i class="fa-brands fa-github"></i><a href="https://github.com/subshegde" target="_blank">Github</a>


            </h3>
            <h3> <i class="fas fa-map-marker-alt"></i> Sirsi ( Uttarakannada ) -581450</h3>
        </div>
    ...
    <footer style="background-color: #f1a809; width: 1220px; " class="py-10 text-center ">
      ...
      </footer><?php /**PATH C:\xampp\htdocs\Laravel\htnlbuilderfy-app\resources\views/subh.blade.php ENDPATH**/ ?>