...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('frontend/a.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('frontend/sinup.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('frontend/bird.css')); ?>">
</head>
<body >

  <img src="<?php echo e(asset('frontend/img/deer.jpg.webp')); ?>">
        ...
        <div class="form">
            ...
            <form action="<?php echo e(route('user.add')); ?>" method="post">
              ...
              <?php echo csrf_field(); ?>
                ...
                <div class="inputBox">
                    <input type="text" name="fname" placeholder="First Name" required="" value="<?php echo e(old('fname')); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <?php echo e('First letter should be in capital'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="inputBox">
                        <input type="text" name="lname" placeholder="Last Name" required="" value="<?php echo e(old('lname')); ?>" >
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <?php echo e('Password should contain atleast one uppercase letter, lowercase letter, number, special character and should be atleast 8 characters long'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="forget">Already have an account ?<a href="<?php echo e(url('/login')); ?>">Login</a></p>
                <p class="forget-1">Back to !<a href="<?php echo e(url('/index1')); ?>">Home page</a></p>
...
<?php /**PATH C:\xampp\htdocs\Laravel\htnlbuilderfy-app\resources\views/sinup.blade.php ENDPATH**/ ?>