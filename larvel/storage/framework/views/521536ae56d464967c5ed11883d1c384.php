...
<header>
    ...
    <div class="user">
        <img src="<?php echo e(('frontend/img/portfolio/prasenna.jpeg')); ?>" alt="">
        <h3 class="name">Prasanna Hegde</h3>
...
<section class="home" id="home">
    ...
    <h3>HI THERE !</h3>
    <h1>I'M <span>Prasenna Hegde</span></h1>
    <p>
...
<div class="row">
    ...
    <div class="info">
        <h3> <span> Name : </span> Presena Hegde</h3>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <p>
            Studied from SDM PU COLLEGE ,UJIRE
        </p>
        <p>Grade - 83%</p>
    </div>
...
<div class="row">
    ...
    <div class="content">
        ...
        <div class="info">
            <h3> <i class="fas fa-envelope"></i>prasannahegde3377@gmail.com</h3>
            <h3> <i class="fas fa-phone"></i> +91-9481560185</h3>
            <h3> <i class="fa-brands fa-linkedin-in"></i> 
                <a href="https://www.linkedin.com/in/prasanna-hegde-ab8397268/" target="_blank">Linkedin</a>
...
<?php /**PATH C:\xampp\htdocs\Laravel\htnlbuilderfy-app\resources\views/presennna.blade.php ENDPATH**/ ?>