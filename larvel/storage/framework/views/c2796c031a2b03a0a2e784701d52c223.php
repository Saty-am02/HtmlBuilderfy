...
<head>
    ...
    <link rel="stysheet" href="<?php echo e(asset('frontend/Portfoli/tailwaind.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/Portfoli/output.css')); ?>">
...
<header>
    ...
    <div class="user">
        <img src="<?php echo e(asset('frontend/img/Portfolio/WhatsApp div 8.57.45 PM 8.57.45 PM 8.57.45 PM 8.57.45 PM.jpeg')); ?>" alt="">
...
<div class="row">
    ...
    <div class="info">
        ...
        <a href="<?php echo e(asset('frontend/img/Portfolio/Resume- Divyanka Mishra.pdf')); ?>" target="_blank"><button class="btn"> Download Resume <i class="fas fa-download"></i> </button></a>
    </div>
...
<!-- custom js file link  -->
<script src="<?php echo e(asset('frontend/javascript/javascript.js')); ?>"></script>


</body>
</html><?php /**PATH C:\xampp\htdocs\Laravel\htnlbuilderfy-app\resources\views/divyanka.blade.php ENDPATH**/ ?>