...
<header>
    ...
    <div class="user">
        <img src="<?php echo e(('frontend/img/portfolio/snehaimage.jpeg')); ?>" alt="">
...
<div class="row">
    ...
    <div class="info">
        ...
        <a href="<?php echo e(('frontend/img/Portfolio/sneharesume.pdf')); ?>" target="_blank"><button class="btn"> Download Resume <i class="fas fa-download"></i> </button></a>
    </div>
...
<div class="row">
    ...
    <footer style="background-color: #f1a809; width: 1220px; " class="py-10 text-center ">
      ...
      </footer><?php /**PATH C:\xampp\htdocs\Laravel\htnlbuilderfy-app\resources\views/sneha.blade.php ENDPATH**/ ?>