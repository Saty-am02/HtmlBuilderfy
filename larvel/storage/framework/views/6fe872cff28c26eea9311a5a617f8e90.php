...
<header>
    ...
    <div class="user">
        <img src="<?php echo e(('frontend/img/portfolio/myphoto_1.jpg')); ?>" alt="">
...
<div class="row">
    ...
    <div class="info">
        ...
        <a href="<?php echo e(asset('frontend/img/Portfolio/dhaivatparmarresume.jpg')); ?>" target="_blank"><button class="btn"> Download Resume <i class="fas fa-download"></i> </button></a>
    </div>
...
<div class="row">
    ...
    <footer style="background-color: #f1a809; width: 1220px; " class="py-10 text-center ">
      ...
      </footer><?php /**PATH C:\xampp\htdocs\Laravel\htnlbuilderfy-app\resources\views/dhaivat.blade.php ENDPATH**/ ?>