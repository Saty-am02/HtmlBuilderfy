...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/pstyle.css')); ?>">
...
<header>
    <div class="user">
        <img src="<?php echo e(asset('frontend/img/Portfolio/sirsatyam.jpg')); ?>" alt="">
    ...
    <nav class="navbar">
        <ul>
            ...
            <li><a href="<?php echo e(url('/about')); ?>">Go Back!</a></li>
...
<div class="row">
    ...
    <footer>
<?php /**PATH C:\xampp\htdocs\Laravel\htnlbuilderfy-app\resources\views/satyam.blade.php ENDPATH**/ ?>